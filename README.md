...
other things are output from gg or git
	...
	>>>> git init
	Initialized empty Git repository in /Users/wujinnnnn/sourceCodes/githubs/gg/demo/.git/
	>>>> git add makefile
	>>>> git commit --allow-empty -m "init a repository"
	[master (root-commit) 054192d] init a repository
	...
	Already on 'master'
	[master 1d2bb74] Init commit as gg repertory
	Switched to a new branch 'develop'
	>>>> git --no-pager log --oneline --decorate
	1d2bb74 (HEAD -> develop, master) Init commit as gg repertory
	054192d init a repository
	#=============================================
	...
	>>>> git --no-pager log --oneline --decorate
	1d2bb74 (HEAD -> test|master, test|develop, master, develop) Init commit as gg repertory
	054192d init a repository
	...
	[develop 6b8e590] add file in develop
	...
	* master
	...
	Saved working directory and index state WIP on master: 1d2bb74 Init commit as gg repertory
	HEAD is now at 1d2bb74 Init commit as gg repertory
	>>>> gg-ck d
	Switched to branch 'develop'
	>>>> git stash pop
	...
	Dropped refs/stash@{0} (5d325721430e6ed03026adfce474f2b2c2b7a45a)
	>>>> git commit -m "add file in master, but we can only commit in develop"
	[develop d1b5fa6] add file in master, but we can only commit in develop
	 1 file changed, 1 insertion(+)
	...
	[develop c1a85a7] make some changes and then we can make a release
	...
	press ENTER to continue, press Ctrl+C to ESCAPE
	[develop 59b4551] Start to release version v0.1
	...
	[release-v0.1 1f6de89] modify the version number in README
	 1 file changed, 1 insertion(+)
	...
	Merge made by the 'recursive' strategy.
	 ...
	 1 file changed, 1 insertion(+)
	 create mode 100644 README.txt
	[develop a70c6d3] Merge branch release-v0.1 into develop
	 Date: Fri Jul 22 14:38:36 2016 +0800
	press Enter to delete branch release-v0.1
	press ENTER to continue, press Ctrl+C to ESCAPE
	Deleted branch release-v0.1 (was 1f6de89).
	>>>> git --no-pager log --oneline --decorate --graph
	*   a70c6d3 (HEAD -> develop) Merge branch release-v0.1 into develop
	|\
	| * 1f6de89 modify the version number in README
	|/
	* 59b4551 Start to release version v0.1
	* c1a85a7 (tag: someTagName) make some changes and then we can make a release
	* d1b5fa6 add file in master, but we can only commit in develop
	* 6b8e590 add file in develop
	* 1d2bb74 (test|master, test|develop) Init commit as gg repertory
	* 054192d init a repository
	...
	[hotfix-v0.1.1 966e90c] fix bugs in hotfix v0.1.1
	...
	[issues/#1-FromBranch-hotfix-v0.1.1 72928e6] fix bugs for issues/#1/test/for/multi/slash/name
	...
	Deleted branch issues/#1-FromBranch-hotfix-v0.1.1 (was 72928e6).
	>>>> echo "version: v0.1.1" > README.txt
	>>>> git add README.txt
	>>>> git commit -m"close hotfix-v0.1.1"
	[hotfix-v0.1.1 6bc0c92] close hotfix-v0.1.1
	...
	Deleted branch hotfix-v0.1.1 (was 6bc0c92).
	>>>> git --no-pager log --oneline --decorate --graph
	*   cea47bb (HEAD -> develop) Merge hotfix branch hotfix-v0.1.1 into develop
	|\
	| * 6bc0c92 close hotfix-v0.1.1
	| *   9dd0cf0 Merge issue branch issues/#1-FromBranch-hotfix-v0.1.1 into hotfix-v0.1.1
	| |\
	| | * 72928e6 fix bugs for issues/#1/test/for/multi/slash/name
	| |/
	| * 966e90c fix bugs in hotfix v0.1.1
	| *   4b323b4 (tag: v0.1) Merge release branch release-v0.1 into master
	| |\
	* | \   a70c6d3 Merge branch release-v0.1 into develop
	|\ \ \
	| | |/
	| |/|
	| * | 1f6de89 modify the version number in README
	...
	* 054192d init a repository
	...
	[develop ebd8900] some changes in develop
	 1 file changed, 1 insertion(+)
	...
	[feature/fly 671dbc6] use empty commit to make a relative loooooooooooooooooooooooooooooooooooooooooooong description for this branch
	>>>> echo "new features" >> newFeature.txt && git add newFeature.txt && git commit -m "add new feature in feature/fly branch"
	[feature/fly 738d119] add new feature in feature/fly branch
	 1 file changed, 1 insertion(+)
	...
	Switched to branch 'develop'
	[develop 5f56e88] new changes in inDevelop
	 1 file changed, 1 insertion(+)
	...
	You must be in one feature branch to update it with the develop!
	...
	Do you want to update it with the develop like this?
	...
	[feature/fly af4377f] add more new feature in feature/fly branch
	 1 file changed, 1 insertion(+)
	...
	[issues/#2-FromBranch-feature/fly db8b92f] fix issues
	 1 file changed, 1 insertion(+)
	>>>> gg-issues-close
	...
	Deleted branch issues/#2-FromBranch-feature/fly (was db8b92f).
	...
	[feature/fly 7732d41] add more new feature in feature/fly branch
	 1 file changed, 1 insertion(+)
	>>>> gg-feature-close
	You are in branch ||   feature/fly   ||
	Do you want to close it like this?
		git checkout "develop"
		git merge --no-ff "feature/fly" "develop"
		git branch -d "feature/fly"

		if you meet conflicts in merges and want to abort the merge, you should delete the branch manully
	press ENTER to continue, press Ctrl+C to ESCAPE
	...
	Deleted branch feature/fly (was 7732d41).
	>>>> git --no-pager log --oneline --decorate --graph
	*   29a1111 (HEAD -> develop) Merge feature branch feature/fly into develop
	|\
	| * 7732d41 add more new feature in feature/fly branch
	| *   77a37ea Merge issue branch issues/#2-FromBranch-feature/fly into feature/fly
	| |\
	| | * db8b92f fix issues
	| |/
	| * af4377f add more new feature in feature/fly branch
	| *   c4b86a1 Merge(update) branch develop into feature/fly
	| |\
	| |/
	|/|
	* | 5f56e88 new changes in inDevelop
	| * 738d119 add new feature in feature/fly branch
	| * 671dbc6 use empty commit to make a relative loooooooooooooooooooooooooooooooooooooooooooong description for this branch
	|/
	* ebd8900 some changes in develop
	*   cea47bb Merge hotfix branch hotfix-v0.1.1 into develop
	|\
	| * 6bc0c92 close hotfix-v0.1.1
	| *   9dd0cf0 Merge issue branch issues/#1-FromBranch-hotfix-v0.1.1 into hotfix-v0.1.1
	| |\
	...
	* 054192d init a repository
	...
	[develop 42121a6] Start to release version v0.2
	...
	[release-v0.2 b64f1e5] modify the version number in README
	 1 file changed, 1 insertion(+), 1 deletion(-)
	>>>> gg-release-close
	...
	Merge made by the 'recursive' strategy.
	 README.txt | 2 +-
	 1 file changed, 1 insertion(+), 1 deletion(-)
	[develop b9a73e9] Merge branch release-v0.2 into develop
	 Date: Fri Jul 22 14:38:39 2016 +0800
	press Enter to delete branch release-v0.2
	press ENTER to continue, press Ctrl+C to ESCAPE

	Deleted branch release-v0.2 (was b64f1e5).
	>>>> git --no-pager log --oneline --decorate --graph --tags
	*   1c598a1 (tag: v0.2, master) Merge release branch release-v0.2 into master
	|\
	| * b64f1e5 modify the version number in README
	| * 42121a6 Start to release version v0.2
	| *   29a1111 Merge feature branch feature/fly into develop
	| |\
	| | * 7732d41 add more new feature in feature/fly branch
	| | *   77a37ea Merge issue branch issues/#2-FromBranch-feature/fly into feature/fly
	| | |\
	...
	| * \   a70c6d3 Merge branch release-v0.1 into develop
	| |\ \
	* | \ \   b107434 (tag: v0.1.1) Merge hotfix branch hotfix-v0.1.1 into master
	|\ \ \ \
	| | |_|/
	| |/| |
	| * | | 6bc0c92 close hotfix-v0.1.1
	...
	* 054192d init a repository
	...
	>>>> gg-ck d && echo "some changes in develop" >> inDevelop.txt && git add inDevelop.txt && git commit -m"new changes in inDevelop"
	Already on 'develop'
	[develop 2315e44] new changes in inDevelop
	 1 file changed, 1 insertion(+)
	>>>> gg-feature-open F
	...
	[issues/I-FromBranch-feature/F 64353ae] issues branch to be tested
	>>>> echo "some issues" >> issues.txt && git add issues.txt && git commit -m"new issues"
	[issues/I-FromBranch-feature/F 3740ae4] new issues
	 1 file changed, 1 insertion(+)
	...
	[issues/I-FromBranch-feature/F%trials.T1 0a1668c] trials1
	 1 file changed, 1 insertion(+)
	...
	[issues/I-FromBranch-feature/F%trials.T2 53fa7f0] trials2
	 1 file changed, 1 insertion(+)
	...
	[issues/I-FromBranch-feature/F%trials.T2%trials.T21 0be036b] trials21
	 1 file changed, 1 insertion(+)
	...
	Deleted branch issues/I-FromBranch-feature/F%trials.T2%trials.T21 (was 0be036b).
	>>>> echo "some trials" >> trials2.txt && git add trials2.txt && git commit -m"trials2"
	[issues/I-FromBranch-feature/F%trials.T2 8c1f9e2] trials2
	 1 file changed, 1 insertion(+)
	...
	Deleted branch issues/I-FromBranch-feature/F%trials.T2 (was 8c1f9e2).
	...
	Deleted branch issues/I-FromBranch-feature/F%trials.T1 (was 0a1668c).
	[issues/I-FromBranch-feature/F c829a00] bad close trial branch issues/I-FromBranch-feature/F%trials.T1
	...
	>>>> echo "some issues" >> issues.txt && git add issues.txt && git commit -m"new issues"
	[issues/I-FromBranch-feature/F 83644e4] new issues
	 1 file changed, 1 insertion(+)
	>>>> gg-issues-close
	You are in branch ||   issues/I-FromBranch-feature/F   ||
	Do you want to close it like this?
	...
	Deleted branch issues/I-FromBranch-feature/F (was 83644e4).
	>>>> echo "some features" >> newFeature.txt && git add newFeature.txt && git commit -m"new features"
	[feature/F 45c1d51] new features
	 1 file changed, 1 insertion(+)
	>>>> gg-feature-close
	You are in branch ||   feature/F   ||
	Do you want to close it like this?
		git checkout "develop"
		git merge --no-ff "feature/F" "develop"
	...
	[develop f1678e6] Start to release version v0.3
	...
	[release-v0.3 321d521] modify the version number in README
	 1 file changed, 1 insertion(+), 1 deletion(-)
	>>>> gg-release-close
	...
	Merge made by the 'recursive' strategy.
	 README.txt | 2 +-
	 1 file changed, 1 insertion(+), 1 deletion(-)
	[develop 8391b27] Merge branch release-v0.3 into develop
	 Date: Fri Jul 22 14:38:42 2016 +0800
	press Enter to delete branch release-v0.3
	press ENTER to continue, press Ctrl+C to ESCAPE

	Deleted branch release-v0.3 (was 321d521).
	>>>> git --no-pager log --oneline --decorate --graph --tags
	*   73b9b3c (tag: v0.3, master) Merge release branch release-v0.3 into master
	|\
	| * 321d521 modify the version number in README
	| * f1678e6 Start to release version v0.3
	| * b747d9a new changes in inDevelop
	| *   3d04213 Merge feature branch feature/F into develop
	| |\
	| | * 45c1d51 new features
	| | *   012edf6 Merge issue branch issues/I-FromBranch-feature/F into feature/F
	| | |\
	| | | * 83644e4 new issues
	| | | * c829a00 bad close trial branch issues/I-FromBranch-feature/F%trials.T1
	| | | *   d3dbd72 Merge branch issues/I-FromBranch-feature/F%trials.T2 into issues/I-FromBranch-feature/F
	| | | |\
	| | | | * 8c1f9e2 trials2
	| | | | *   e39489e Merge branch issues/I-FromBranch-feature/F%trials.T2%trials.T21 into issues/I-FromBranch-feature/F%trials.T2
	| | | | |\
	| | | | | * 0be036b trials21
	| | | | |/
	| | | | * 53fa7f0 trials2
	| | | |/
	| | | * 3740ae4 new issues
	| | | * 64353ae issues branch to be tested
	| | |/
	| | * 4648537 new features
	| | * 9e6bb1b feature branch to be tested
	| |/
	| * 2315e44 new changes in inDevelop
	| *   b9a73e9 Merge branch release-v0.2 into develop
	| |\
	* | \   1c598a1 (tag: v0.2) Merge release branch release-v0.2 into master
	|\ \ \
	| | |/
	| |/|
	| * | b64f1e5 modify the version number in README
